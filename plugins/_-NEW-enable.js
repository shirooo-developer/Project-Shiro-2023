...
let name = await conn.getName(who)
  ...
  switch (type) {
    ...
    case 'statusonly':
      ...
      break
    default:
       if (!/[01]/.test(command)) return m.reply(` *〔 llı OPTIONS ıll 〕*
...
📮Pastikan Huruf kecil semua!`)
   } 
     
let cep = `*${htki} STATUS ${htka}* 
 📔  *Type:*   ${type}  
 🗞️  *Status:*   Succes ✅ 
 💻️  *Options:*   ${isEnable ? 'ON' : 'OFF'} 
 🗳️  ${isAll ? 'Bot Only' : isUser ? '' : 'Chat Only'}
 `
conn.sendFile(m.chat, om, null, cep, fkontak) 
}   
